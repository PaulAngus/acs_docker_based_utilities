...
#docker run -it --entrypoint /bin/bash -v $remote_tmp_output_dir:$local_docker_output_dir --env build_type=$build_type --env acs_version=$acs_version --env remote_tmp_output_dir=$remote_tmp_output_dir $img
docker run -v $remote_tmp_output_dir:$local_docker_output_dir --env build_type=$build_type --env acs_version=$acs_version --env remote_tmp_output_dir=$remote_tmp_output_dir $img
